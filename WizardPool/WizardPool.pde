...
// runs once at start
void setup(){
  players.add("Wizard 1");
  players.add("Wizard 2");
  leftWizard = loadImage("wizard_one.jpg");
  rightWizard = loadImage("wizard_two.png");
...
void draw(){
  ...
  if(gameWon){
   ...
   int leaderboardButtonHeight = 120;
    ...
    textSize(50);
    text("----------",  leaderboardButtonX+8, leaderboardButtonY + leaderboardButtonHeight/2+10);
